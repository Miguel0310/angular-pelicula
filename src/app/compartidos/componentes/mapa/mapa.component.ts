...
export class MapaComponent implements OnInit{
  ...
  @Output()
  coordenadaSelecionada = new EventEmitter<Coordenada>();
  ...
  markerOptions: MarkerOptions = {
    icon: icon({
      ...
      iconRetinaUrl: 'assets/marker-icone-2x.png',
  ...
  options = {
    ...
    zoom: 14,
    center: latLng(-26.2649037872471, -48.84736488375985)
  }
  ...
  manejarClick(event: LeafletMouseEvent){
    ...
    this.coordenadaSelecionada.emit({latitud, longitud})
