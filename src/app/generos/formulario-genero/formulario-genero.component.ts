...
import { primeraLetaMayuscula, noInicioEspacio } from '../../compartidos/funciones/validaciones';
...
export class FormularioGeneroComponent implements OnInit{
  ...
  @Output()
  posteoFormulario = new EventEmitter<GeneroCrecionDTO>();
  ...
  guardarCambios(){
     ...
     const genero = this.form.value as GeneroCrecionDTO;
